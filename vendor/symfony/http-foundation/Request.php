...
class Request
{
     ...
     *
     * [请注意，启用此功能可能会导致代码中的CSRF问题。
     *  当需要时，检查是否使用了CSRF标记。
     *  如果启用了HTTP方法参数覆盖，则可以修改带有方法“POST”的html表单
     *  用于通过_method请求参数发送“PUT”或“DELETE”请求。
     *  如果这些方法不受CSRF的保护，就会出现漏洞。]
     *
     * The HTTP method can only be overridden when the real HTTP method is POST.
     * [HTTP方法只能在真正的HTTP方法POST时被覆盖。]
     */
